...
def flatten_summary(summary, extra):
    return {
        **extra,
        ...
        "input_token_mean": summary["prefill"]["input_token_count"]["mean"],
        "input_token_p95": summary["prefill"]["input_token_count"]["p95"],
        "input_image_mean": summary["prefill"]["input_image_count"]["mean"],
        "history_image_mean": summary["prefill"]["history_image_count"]["mean"],
        "prompt_char_mean": summary["prefill"]["prompt_char_count"]["mean"],
        "image_token_mean": summary["prefill"]["image_token_count"]["mean"],
