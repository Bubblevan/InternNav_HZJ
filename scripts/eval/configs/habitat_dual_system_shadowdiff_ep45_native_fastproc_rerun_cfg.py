...
eval_cfg.eval_settings["output_path"] = "./logs/habitat/shadowdiff_ep45_native_fastproc_rerun"
...
eval_cfg.agent.model_settings["shadow_diff_dump_images"] = False
eval_cfg.agent.model_settings["shadow_diff_hf_model_path"] = (
    "checkpoints/InternVLA-N1-DualVLN-qwen25vl-s2-view"
)
eval_cfg.agent.model_settings["shadow_diff_hf_processor_use_fast"] = "true"
