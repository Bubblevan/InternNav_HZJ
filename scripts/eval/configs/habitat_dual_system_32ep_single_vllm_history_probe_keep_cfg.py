...
eval_cfg.eval_settings["output_path"] = "./logs/habitat/test_dual_system_32ep_single_vllm_history_probe_keep"
eval_cfg.agent.model_settings["enable_history_probe"] = True
eval_cfg.agent.model_settings["history_probe_mode"] = "keep_one"
eval_cfg.agent.model_settings["history_probe_max_steps"] = 4
